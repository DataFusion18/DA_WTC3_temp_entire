...
#### Step 3: Read the modeled GPP data   

##### Model canopy scale GPP from the leaf scale measurements of photosynthetic parameters using MAESPA

##### Data used: 
1. Modelled daily C gain (GPP) from Dushan's analysis    

**Figure 3**: Daily GPP of Eucalyptus tereticornis trees for both temperature treatments. The grey bars represent standard errors for sample size, n=3.    

```{r GPP_data_total, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE, fig.path = "Figures/", fig.width = 9, fig.height = 6}
source('R/GPP_data_total.R')
```


<!-- #---------------------------------------------------------------------------------------------------------------- -->	
<!-- #---------------------------------------------------------------------------------------------------------------- -->	
#### Step 4: Read and process the leaf count and leaf size dataset, return a dataframe of gapfilled LA data before the flux measurement starts
```{r calculate.LA, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE}
source('R/la_estimates.R')
```


<!-- #---------------------------------------------------------------------------------------------------------------- -->	
<!-- #---------------------------------------------------------------------------------------------------------------- -->	
#### Step 5: Process the met data from the start of the experiment (Dec 2012) to start of flux measurement (Sept 2013)   

```{r process.met.data, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE}
source('R/process.met.data.R')
```
...
write.csv(data.GPP.LA.mass, file = "processed_data/GPP_LA_mass.csv", row.names = FALSE)
```
